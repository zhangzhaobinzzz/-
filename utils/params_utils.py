...
from utils.config import vocab_path, train_x_seg_path, train_y_seg_path, test_x_seg_path, \
    sample_total, batch_size, save_result_dir, epochs, checkpoint_dir, vocab_size
...
def get_params():
    ...
    parser.add_argument("--max_dec_len", default=34, help="Decoder input max sequence length", type=int)
